...
def update_screen(ai_settings, stats, screen, sb, ship, aliens, bullets, play_button):
	""" Update images on the svreen and flid to the new screen."""
	# Redrawing the screen during each pass
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
	"""Respons to ship being hit by alien."""
...
def check_aliens_bottom(ai_settings, stats, screen, ship, aliens, bullets):
	...
	for alien in aliens.sprites():
		if alien.rect.bottom >= screen_rect.bottom:
			...
			shit_hit(ai_settings, stats, screen, ship, aliens, bullets)
			break
...
def get_number_rows(ai_settings, ship_height, alien_height):
	"""Determine the nuymber of rows of aliens that fit on the screen."""
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	# Create an alien and find the nhnumber of aliens ina row
	# Spacing between each alien is equyal to one alien width.
	alien = Alien(ai_settings, screen)
